<form method="POST" class="application" accept-charset="UTF-8" action="https://pay.paymentnepal.com/alba/input">
...
<?php } else { 
	      if($pay_type) {
?>
<link rel="stylesheet" type="text/css" href="/catalog/view/theme/default/stylesheet/paymentnepal.css" />
